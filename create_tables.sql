...
CREATE TABLE IF NOT EXISTS "app_main_seriesmodel_genre" (
	"id"	integer NOT NULL,
	"seriesmodel_id"	bigint NOT NULL,
	"genremodel_id"	bigint NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("genremodel_id") REFERENCES "app_main_genremodel"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("seriesmodel_id") REFERENCES "app_main_seriesmodel"("id") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE IF NOT EXISTS "app_main_softwaresgamesmodel_genre" (
	"id"	integer NOT NULL,
	"softwaresgamesmodel_id"	bigint NOT NULL,
	"genremodel_id"	bigint NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("softwaresgamesmodel_id") REFERENCES "app_main_softwaresgamesmodel"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("genremodel_id") REFERENCES "app_main_genremodel"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE TABLE IF NOT EXISTS "app_main_moviemodel_genre" (
	"id"	integer NOT NULL,
	"moviemodel_id"	bigint NOT NULL,
	"genremodel_id"	bigint NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("moviemodel_id") REFERENCES "app_main_moviemodel"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("genremodel_id") REFERENCES "app_main_genremodel"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE TABLE IF NOT EXISTS "app_main_bsubmodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	integer,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("movie_content_id") REFERENCES "app_main_moviemodel"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE TABLE IF NOT EXISTS "app_main_classicmodel" (
	"id"	integer NOT NULL,
	"type"	varchar(50),
	"created_at"	datetime NOT NULL,
	"movie_content_id"	integer,
...
CREATE TABLE IF NOT EXISTS "app_main_dualaudiomodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	integer,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_genremodel" (
	"id"	integer NOT NULL,
	"genre_name"	varchar(20) NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "app_main_hindidubbedmodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	integer,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_imdbtopmodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	integer,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_jamesbondmodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	integer,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_oscarwinningmodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS "app_main_satyajitraymodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	bigint,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_specialmodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	bigint,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_superheromodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	bigint,
	PRIMARY KEY("id" AUTOINCREMENT),
...
CREATE TABLE IF NOT EXISTS "app_main_topslidemodel" (
	"id"	integer NOT NULL,
	"created_at"	datetime NOT NULL,
	"movie_content_id"	bigint,
	"series_content_id"	bigint,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("series_content_id") REFERENCES "app_main_seriesmodel"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("movie_content_id") REFERENCES "app_main_moviemodel"("id") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE IF NOT EXISTS "app_main_softwaresgamesmodel" (
	"id"	integer NOT NULL,
	"title"	varchar(250),
	"slug"	varchar(250),
	"poster"	varchar(100),
...
CREATE TABLE IF NOT EXISTS "app_main_seriesmodel" (
	"id"	integer NOT NULL,
	"title"	varchar(250),
	"slug"	varchar(250),
	"description"	text,
...
CREATE TABLE IF NOT EXISTS "app_main_moviemodel" (
	"id"	integer NOT NULL,
	"title"	varchar(250),
	"slug"	varchar(250),
	"description"	text,
...
CREATE TABLE IF NOT EXISTS "app_main_episodemodel" (
	"id"	integer NOT NULL,
	"title"	varchar(250),
	"thumbnail"	varchar(100),
	"episode"	integer,
	...
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("season_id") REFERENCES "app_main_seasonmodel"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE TABLE IF NOT EXISTS "app_main_seasonmodel" (
	"id"	integer NOT NULL,
	"thumbnail"	varchar(100),
	"release_date"	date,
	...
	"slug"	varchar(250),
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("series_id") REFERENCES "app_main_seriesmodel"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE TABLE IF NOT EXISTS "app_main_bsubcreatormodel" (
	"id"	integer NOT NULL,
	"name"	varchar(255),
...
CREATE TABLE IF NOT EXISTS "app_main_moviemodel_bsub_creator" (
	"id"	integer NOT NULL,
	"moviemodel_id"	bigint NOT NULL,
	"bsubcreatormodel_id"	bigint NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("bsubcreatormodel_id") REFERENCES "app_main_bsubcreatormodel"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("moviemodel_id") REFERENCES "app_main_moviemodel"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE TABLE IF NOT EXISTS "app_main_seriesmodel_bsub_creator" (
	"id"	integer NOT NULL,
	"seriesmodel_id"	bigint NOT NULL,
	"bsubcreatormodel_id"	bigint NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT),
